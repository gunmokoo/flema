...
while running: # True 시 진행 False 시 종료
    ...
    game_downs = [ [g[0], g[1] + game_down_speed] for g in game_downs] # x, y 값 갱싱
    ...
    if game >=1: # 변수가 1이상 일 때
        ...
        timer = game_font.render(str(elapsed_time), True, (255, 255, 255)) # 시간 표시 폰트 이미지 불러오기
        screen.blit(timer, (1000 ,10)) # 게임 중 시간 표시
